            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('sapi-jual.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="kode_sapi" id="kode_sapi" required>
                                    ...
                                    <option value="{{ $sapi->id }}" data-jenis="{{ $sapi->jenis }}">{{ $sapi->id }} -
                                        {{ $sapi->jenis }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="tgl_siap" class="form-label">Tanggal Siap</label>
                                <input type="date" class="form-control" id="tgl_siap" name="tgl_siap" required>
                            </div>
