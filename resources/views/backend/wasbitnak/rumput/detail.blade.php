        ...
        <div class="">
            <div class="card">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9 col-md-8">
                                <input type="text" name="rumput_berat_hasil" class="form-control"
                                    value="{{ $rumput->rumput_berat_hasil }}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9 col-md-8">
                                <input name="rumput_masuk" type="date" class="form-control"
                                    value="{{ $rumput->rumput_masuk }}" disabled>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-lg-3 col-md-4 label">Keterangan</div>
                            <div class="col-lg-9 col-md-8">
                                <textarea name="rumput_keterangan" class="form-control"
                                    disabled>{{ $rumput->rumput_keterangan }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-lg-3 col-md-4 label">Status Rumput</div>
                            <div class="col-lg-9 col-md-8">
                                <select name="rumput_status" class="form-select" disabled>
                ...
                <div class="text-center mb-4">
                    <a href="{{ route('index.rumput.wasbitnak') }}" class="btn btn-outline-secondary">Kembali</a>
                </div>
            </div>
