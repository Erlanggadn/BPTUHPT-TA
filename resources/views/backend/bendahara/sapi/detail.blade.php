                    ...
                    <div class="tab-content pt-2">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9 col-md-8">
                                ...
                                <input type="text" class="form-control" value="{{  $pengajuan->user->pembeli_nama }}"
                                    disabled>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9 col-md-8">
                                <input type="date" name="belisapi_tanggal" id="belisapi_tanggal" class="form-control"
                                    value="{{ $pengajuan->belisapi_tanggal }}" disabled>
                            </div>
                        </div>
                        ...
                        <div id="dynamic-field">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-9 col-md-8">
                                    <select name="detail_kategori[]" id="detail_kategori" class="form-select" disabled>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-9 col-md-8">
                                    <input type="number" name="detail_jumlah[]" id="detail_jumlah" class="form-control"
                                        value="{{ $detail->detail_jumlah }}" disabled>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-lg-3 col-md-4 label">Berat Sapi (KG)</div>
                                <div class="col-lg-9 col-md-8">
                                    <input type="number" name="detail_berat[]" id="detail_berat" class="form-control"
                                        value="{{ $detail->detail_berat }}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-9 col-md-8">
                                    <select name="detail_kelamin[]" id="detail_kelamin" class="form-select" disabled>
