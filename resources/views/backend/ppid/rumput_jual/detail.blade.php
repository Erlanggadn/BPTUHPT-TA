            ...
            <div class="card">
                <div class="card-body pt-3">
                    ...
                    <div class="tab-content pt-2">
                        ...
                        <form action="{{ route('update.ppid.rumput', $rumput->rumput_id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-9 col-md-8">
                                    <input type="text" name="rumput_berat_awal" class="form-control"
                                        value="{{ $rumput->rumput_berat_awal }}" disabled>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-lg-3 col-md-4 label">Berat Rumput Hasil (KG) / Sekarang</div>
                                <div class="col-lg-9 col-md-8">
                ...
                <div class="text-center mb-4">
                    ...
                    <a href="{{ route('index.ppid.rumput') }}" class="btn btn-outline-secondary">Kembali</a>
                </div>
                </form>
