            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <a href="{{ route('export.ppid.sapi', ['jenis_sapi' => request('jenis_sapi')]) }}"
                            class="btn btn-success mb-4">
                            <i class="bi bi-file-earmark-excel"></i> Export to Excel
                        </a>
                        <form action="{{ route('filter.ppid.sapi') }}" method="GET" class="mb-4">
                            <div class="row">
                                <div class="col-md-2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <a class="btn btn-outline-success"
                                            href="{{ route('detail.ppid.sapi', $item->sapi_id) }}"><i
                                                class="bi bi-info-lg"></i></a>
                                        <form id="deleteForm"
                                            action="{{ route('delete.ppid.sapi', $item->sapi_id) }}" method="POST"
                                            style="display: inline;">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button" class="btn btn-outline-danger"
                                                onclick="showDeleteModal('{{ route('delete.ppid.sapi', $item->sapi_id) }}')">
